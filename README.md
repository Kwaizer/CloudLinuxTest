...
## Example commands
1. The next command will traverses `Telegram Desktop` folder and outputs file categories. File categories itself have names, sizes and number of files they have:<br>
`python main.py "/home/<user>/Downloads/Telegram Desktop" --ctg `
2. If you want to know what files are above a certain threshold value, you can specify a value in megabytes with `--thr`:<br>
